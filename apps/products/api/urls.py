...
from apps.products.api.views.products_views import ProductListApiView, ProductCreateApiView, ProductRetrieveAPIView,ProductDestroyAPIView, ProductUpdateAPIView
